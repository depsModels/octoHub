    ...
    <section id="cta" className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <span className="inline-block px-4 py-1 bg-octo-blue text-octo-yellow rounded-full mb-4 text-sm uppercase tracking-wider">Comece Agora</span>
          <h2 className="text-4xl md:text-5xl xl:text-7xl font-bebas uppercase mb-6 text-white">Pronto para Transformar seu Negócio?</h2>
          <div className="w-24 h-1 bg-octo-yellow mx-auto mb-8" />
          <p className="text-xl md:text-2xl xl:text-3xl mb-12 text-octo-yellow">Descubra como a octo.hub pode impulsionar o crescimento da sua empresa com estratégias personalizadas.</p>
