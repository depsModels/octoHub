      ...
      <div className="relative z-20 flex flex-col flex-grow">
        ...
        <div className="container mx-auto px-4 flex flex-col justify-center flex-grow">
          <div className="max-w-3xl p-2">
            <h1 className="text-4xl md:text-6xl xl:text-7xl font-bebas uppercase leading-tight mb-4 md:mb-6 text-white">Especialistas em Captação de Clientes</h1>
            <p className="text-lg md:text-xl xl:text-2xl mb-6 md:mb-8 text-octo-yellow/90">Na octo.hub, ajudamos negócios a estruturarem um processo comercial eficiente para atrair mais clientes, aumentar as vendas e escalar seus resultados. Criamos soluções completas de marketing digital com foco em performance e crescimento real.</p>
