    ...
    <section id="porque-escolher" className="py-12 sm:py-16 md:py-20 px-4 relative">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-10 sm:mb-12 md:mb-16 relative">
          <h2 className="text-3xl md:text-4xl xl:text-6xl font-bebas uppercase mb-4 relative z-10 animate-fade-in">{t('why.titlePrefix')}<span className="text-octo-yellow relative"> octo</span>?</h2>
          <div className="w-24 h-1 bg-gradient-to-r from-octo-green via-octo-yellow to-octo-green mx-auto mb-6" />
          <p className="max-w-2xl mx-auto text-sm sm:text-base xl:text-xl text-octo-yellow/90 mb-8">{t('why.desc')}</p>
        ...
        <div className="hidden lg:flex lg:flex-row gap-12 items-center mb-8 sm:mb-12 md:mb-16">
          <div className="w-1/2">
            <div className="flex flex-col space-y-4 sm:space-y-6">
              {[{icon:'fa-sitemap',title:t('why.methodologies.title'),text:t('why.methodologies.text')},{icon:'fa-users',title:t('why.team.title'),text:t('why.team.text')},{icon:'fa-flask',title:t('why.impact.title'),text:t('why.impact.text')}].map(c => (
          ...
          <div className="w-1/2">
            ...
            <div className="absolute top-4 right-4 bg-octo-yellow/80 text-octo-blue px-4 py-1 rounded-full text-sm font-bold">{t('why.teamBadge')}</div>
          </div>
        </div>
        ...
        <div className="block lg:hidden mb-6">
          <div className="w-full mb-8">
            <div className="relative group rounded-xl sm:rounded-2xl overflow-hidden h-full">
              ...
              <div className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-octo-yellow/80 text-octo-blue px-3 py-1 sm:px-4 sm:py-1 rounded-full text-xs sm:text-sm font-bold">{t('why.teamBadge')}</div>
            </div>
          </div>
        </div>
